...
lazy_static! {
    ...
    pub(crate) static ref JWT_REFRESH_SECRET: &'static [u8] = STRING_JWT_REFRESH_SECRET.as_bytes();
    pub(crate) static ref JWT_ACCESS_SECRET: &'static [u8] = STRING_JWT_ACCESS_SECRET.as_bytes();
}
